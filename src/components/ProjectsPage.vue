    ...
    <div class=project-container>
        ...
        <div class="skills" @click="redirect('https://github.com/arvidbt/portfolio')">
            ...
            <div class="text-container">
                <h1 class="h1-projects">This website, a Vue playground.</h1>
        ...
        <div class="skills"  @click="redirect('https://github.com/arvidbt/MIRA')">
            <img class="img-left" src="../assets/images/thirty.png"/>
            <div class="text-container">
                <h1 class="h1-projects">MIRA, a CRUD application.</h1>
                <h3 class="h3-projects">A web application me and my friend Tomas Diaz made during a introduction course to databases.</h3>
                <h3 class="h3-projects">The goal was simpel. Build a webapplication using three different database tables. We decided to build a very simpel ToDo-app, since we both were novices in JavaScript.</h3>
        ...
        <div class="skills" @click="redirect('https://github.com/arvidbt/PBLogger')">
            <img class="img-left" src="../assets/images/thirty.png"/>
            <div class="text-container">
                <h1 class="h1-projects">PBLogger, an Android training app.</h1>
        ...
        <div class="skills">
            <img class="img-left" src="../assets/images/thirty.png"/>
            <div class="text-container">
                <h1 class="h1-projects">Thirty, a Android dice game.</h1>
        ...
        <div class="skills">
            <img class="img-left" src="../assets/images/thirty.png"/>
            <div class="text-container">
                <h1 class="h1-projects">Anti-Tower Defence, a game built with Swing.</h1>
         ...
         <div class="skills" @click="redirect('https://github.com/arvidbt/2048')">
            <img class="img-left" src="../assets/images/thirty.png"/>
            <div class="text-container">
                <h1 class="h1-projects">2048 in Java, my first project.</h1>
                ...
                <p class="p-projects">Tools used: Java, Swing, C</p>
            </div>
        </div>
    </div>
</template>
